...
- ニュアンス調整後の翻訳を敬語で日本語に訳す
- ニュアンス調整で追加された表現の差分を必ず反映すること（各パーセンテージ間の逆翻訳のトーンに差を出す）
- 二重敬語は使わず、正しい敬語を使う
...
- 敬語（丁寧語・謙譲語・尊敬語）で出力すること。ただし主語が話者本人の動作には尊敬語を使わないこと`;
    ...
    return `【逆翻訳】
- reverse_translation は日本語で出力
- ニュアンス調整後の翻訳を友達に話すようなくだけた口調で日本語に訳す
- ニュアンス調整で追加された表現の差分を必ず反映すること（各パーセンテージ間の逆翻訳のトーンに差を出す）
- 敬語・丁寧語（です/ます）を使わない
- 人名の敬称は原文に従うこと。原文に「さん」「様」がなければ付けない
- 原文と同じ意味の語は、できるだけ原文の語彙に揃えること
...
- ニュアンス調整後の${targetLang}を${sourceLang}に訳す
